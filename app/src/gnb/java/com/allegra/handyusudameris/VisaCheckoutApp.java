...
/*        UAirship.takeOff(this, new UAirship.OnReadyCallback() {
        ...
        AirshipConfigOptions options = new AirshipConfigOptions.Builder()
                .setDevelopmentAppKey("9L11nNoZRHOKu5X7VOaY2w")
                .setDevelopmentAppSecret("pLURjRhAQxmUsqIYMBhoUQ")
                .setProductionAppKey("VFxtj4YMS8i_Qjvkura7hg")
                .setProductionAppSecret("pryyX0rORIqR_Njy2n0cGA")
                .setInProduction(!BuildConfig.DEBUG)
                .setGcmSender("339987041787")// FCM/GCM sender ID
                .build();
